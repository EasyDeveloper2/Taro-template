...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "$compid__32", "countdownStatus", "phone", "code"], _this.config = {
    ...
    }, _this.customComponents = ["MLCountDown"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Index, [{
    ...
    value: function _createData() {
      ...
      this.anonymousFunc0 = function (_ref2) {
      ...
      this.anonymousFunc1 = function (_ref3) {
      ...
      this.anonymousFunc2 = function (status) {
        // 检验手机号码是否为空 并且格式是否正确
      ...
      _taroWeapp.propsManager.set({
        ...
        "onStart": this.anonymousFunc2,
        "onStop": this.anonymousFunc3
  ...
  return Index;
}(_taroWeapp.Component), _class.$$events = ["anonymousFunc0", "anonymousFunc1", "anonymousFunc4", "onBindWxPhone"], _class.$$componentPath = "pages/login/index", _temp2);
