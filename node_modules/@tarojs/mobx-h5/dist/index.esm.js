import Taro, { Component, useState } from '@tarojs/taro-h5';
import { setStore, inject, mapStoreToProps, getInjectName, isUsingStaticRendering, errorsReporter, PropTypes, onError, useStaticRendering, useLocalStore, useAsObservableSource } from '@tarojs/mobx-common';
export { PropTypes, onError, isUsingStaticRendering, useStaticRendering } from '@tarojs/mobx-common';
...
function createStoreInjector(grabStoresFn, injectNames, sourceComponent) {
  ...
  function (_Component) {
    ...
    _createClass(Injector, [{
      ...
      value: function render() {
        ...
        var originProps = mapStoreToProps(grabStoresFn, this.props);
        return createElement(sourceComponent, _objectSpread({}, originProps, {
  ...
  _defineProperty(Injector, "displayName", getInjectName(sourceComponent, injectNames));
...
function useLocalStore$1(initializer, current) {
  return useLocalStore(initializer, current, useState);
}

function useAsObservableSource$1(current) {
  return useAsObservableSource(current, useState);
}
...
var index = {
  ...
  inject: inject$1,
  Provider: Provider,
  useLocalStore: useLocalStore$1,
  useAsObservableSource: useAsObservableSource$1,
  isUsingStaticRendering: isUsingStaticRendering,
  useStaticRendering: useStaticRendering
};

export default index;
export { observer, inject$1 as inject, Provider, useLocalStore$1 as useLocalStore, useAsObservableSource$1 as useAsObservableSource };
